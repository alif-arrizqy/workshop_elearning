...
class User extends CI_Controller
{
	...
	function save_ambil_matkul_user()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if (empty($pambagisi[0])) {
				$tambah1 = 0;
			} else {
				$tambah1 = 1;
			}
			if (empty($pambagiorkom[0])) {
				$tambah2 = 0;
			} else {
				$tambah2 = 1;
			}
			if (empty($pambagielektronika[0])) {
				$tambah3 = 0;
			} else {
				$tambah3 = 1;
			}
			if (empty($pambagisigit1[0])) {
				$tambah4 = 0;
			} else {
				$tambah4 = 1;
			}
			if (empty($pambagijarkom[0])) {
				$tambah5 = 0;
			} else {
				$tambah5 = 1;
			}
			if (empty($pambagisigit2[0])) {
				$tambah6 = 0;
			} else {
				$tambah6 = 1;
			}
			if (empty($pambagisismik[0])) {
				$tambah7 = 0;
			} else {
				$tambah7 = 1;
			}
			if (empty($pambagiiot[0])) {
				$tambah8 = 0;
			} else {
				$tambah8 = 1;
			}
			if (empty($pambagiadminjar[0])) {
				$tambah9 = 0;
			} else {
				$tambah9 = 1;
			}
			if (empty($pambagispm[0])) {
				$tambah10 = 0;
			} else {
				$tambah10 = 1;
			}
			if (empty($pambagimobile[0])) {
				$tambah11 = 0;
			} else {
				$tambah11 = 1;
			}
			if (empty($pambagipython[0])) {
				$tambah12 = 0;
			} else {
				$tambah12 = 1;
			}
			if (empty($pambagikejar[0])) {
				$tambah13 = 0;
			} else {
				$tambah13 = 1;
			}
			if (empty($pambagisim[0])) {
				$tambah14 = 0;
			} else {
				$tambah14 = 1;
			}
			if (empty($pambagirobotik[0])) {
				$tambah15 = 0;
			} else {
				$tambah15 = 1;
			}

			if (empty($pambagisi[1])) {
				$id_kelas_matkul_si = '';
			} else {
				$id_kelas_matkul_si = $pambagisi[1];
			}
			if (empty($pambagiorkom[1])) {
				$id_kelas_matkul_orkom = '';
			} else {
				$id_kelas_matkul_orkom = $pambagiorkom[1];
			}
			if (empty($pambagielektronika[1])) {
				$id_kelas_matkul_elektronika = '';
			} else {
				$id_kelas_matkul_elektronika = $pambagielektronika[1];
			}
			if (empty($pambagisigit1[1])) {
				$id_kelas_matkul_sigit1 = '';
			} else {
				$id_kelas_matkul_sigit1 = $pambagisigit1[1];
			}
			if (empty($pambagijarkom[1])) {
				$id_kelas_matkul_jarkom = '';
			} else {
				$id_kelas_matkul_jarkom = $pambagijarkom[1];
			}
			if (empty($pambagisigit2[1])) {
				$id_kelas_matkul_sigit2 = '';
			} else {
				$id_kelas_matkul_sigit2 = $pambagisigit2[1];
			}
			if (empty($pambagisismik[1])) {
				$id_kelas_matkul_sismik = '';
			} else {
				$id_kelas_matkul_sismik = $pambagisismik[1];
			}
			if (empty($pambagiiot[1])) {
				$id_kelas_matkul_iot = '';
			} else {
				$id_kelas_matkul_iot = $pambagiiot[1];
			}
			if (empty($pambagiadminjar[1])) {
				$id_kelas_matkul_adminjar = '';
			} else {
				$id_kelas_matkul_adminjar = $pambagiadminjar[1];
			}
			if (empty($pambagispm[1])) {
				$id_kelas_matkul_spm = '';
			} else {
				$id_kelas_matkul_spm = $pambagispm[1];
			}
			if (empty($pambagimobile[1])) {
				$id_kelas_matkul_mobile = '';
			} else {
				$id_kelas_matkul_mobile = $pambagimobile[1];
			}
			if (empty($pambagipython[1])) {
				$id_kelas_matkul_python = '';
			} else {
				$id_kelas_matkul_python = $pambagipython[1];
			}
			if (empty($pambagikejar[1])) {
				$id_kelas_matkul_kejar = '';
			} else {
				$id_kelas_matkul_kejar = $pambagikejar[1];
			}
			if (empty($pambagisim[1])) {
				$id_kelas_matkul_sim = '';
			} else {
				$id_kelas_matkul_sim = $pambagisim[1];
			}
			if (empty($pambagirobotik[1])) {
				$id_kelas_matkul_robotik = '';
			} else {
				$id_kelas_matkul_robotik = $pambagirobotik[1];
			}
