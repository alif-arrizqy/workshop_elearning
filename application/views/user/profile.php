  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content"> 
         <?php 
         foreach($detail_matkul as $hasil) : ?>
              <div class="col-md-3 col-sm-3 col-xs-12">
                <div align="center">
                   <a href="<?= base_url('detail_qrcode/').$hasil->kode;?>" id="detail_qrcode" data-toggle="modal" data-target="#modal_detail_qrcode" title="detail <?=$hasil->qrcode;?>">
                     <img src="<?= base_url('assets/images/imgqrcode/absen/').$hasil->qrcode;?>" width="80%" height="80%">
                   </a>
                </div>
              </div>
              <div class="col-md-9 col-sm-3 col-xs-12">
                <table width="100%" style="margin-top:2%; margin-bottom: 10%;font-size: 14px;">   
                  <tr>
                    <td width="30%">Nama Matakuliah</td>
                    <td>: <?= $hasil->kode?></td>
                  </tr>
                  <tr>
