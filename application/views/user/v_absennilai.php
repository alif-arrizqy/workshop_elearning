            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <li class="dropdown navbar-right">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="<?= base_url('cetak_nilai/') . $hasil1->id_kelas_matkul . "/" . $hasil1->kode ?>"><span class="fa fa-print"></span>&nbsp;Cetak Nilai</a></li>
                  <li><a href="<?= base_url('cetak_absen/') . $hasil1->id_kelas_matkul . "/" . $hasil1->kode ?>"><span class="fa fa-print"></span>&nbsp;Cetak Absen</a></li>
                </ul>
              </li>
            </ul>
            <div class="clearfix"></div>
