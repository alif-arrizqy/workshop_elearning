      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2>Absensi Mata Kuliah Yang di Ajar</h2>
          ...
          <div class="x_content">
            <?php if($data_kelas_matkul->num_rows() > 0) {?>
              <?php foreach ($data_kelas_matkul->result() as $hasil_matkul) { $data_mhs = $this->main_model->get_all_data_mhs($hasil_matkul->kode); ?>
                <a href="<?=base_url('user/absen/'.$hasil_matkul->id_kelas_matkul."/".$hasil_matkul->kode)?>">
                  <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="tile-stats">
                      ...
                      ?>
                      <h4 style="color: black;margin-left: 10px; font-size:13px;"><?= $asd1->nama." dan ";?><?php if($hasil_matkul->  asdos_2 != 0){echo $asd2->nama;}else{echo"-";} ?></h4>
                    </div>
                  </div>
                </a>
              <?php } ?>
