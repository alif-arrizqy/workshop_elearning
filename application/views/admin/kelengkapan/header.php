      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="<?= base_url('workshopadministrator') ?>" class="site_title">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <?php if (!empty($this->session->userdata('ses_foto'))) { ?>
                    <img src="<?= base_url('assets/images/gambar_user/') . $this->session->userdata('ses_foto') ?>" alt="">
                  <?php } else { ?>
                    <img src="<?= base_url('assets/images/user.png') ?>" alt=""><?php } ?>
                  <?= $this->session->userdata('ses_name'); ?>
                  <span class=" fa fa-angle-down"></span>
                </a>
                <ul class="dropdown-menu dropdown-usermenu pull-right">
                  <li><a href="<?= base_url('profile_admin') ?>"> Profile
                      <?php $level = $this->session->userdata('ses_level');
                      if ($level == 1) {
                        $sbg = "Super Admin";
                      } else if ($level == 2) {
