...
<div class="modal-dialog">  
  <div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">UBAH PROFILE ADMINISTRATOR</h4>
    </div>
    <form action="<?= base_url('update_administrator_dahsboard');?>" method="post" name="form" enctype="multipart/form-data" class="form-horizontal form-label-left">
