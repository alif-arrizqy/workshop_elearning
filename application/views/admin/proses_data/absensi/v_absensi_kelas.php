<div class="right_col" role="main">
  ...
  <a href="<?=base_url('v_absensi')?>" class="btn btn-info btn-md"><i class="fa fa-reply"></i> Kembali</a>
  <?php if($data_absensi_kelas->num_rows()>0){?>
    <div class="row">
      <div class="col-md-12">
        <div class="">
          <div class="x_content">
            <div class="row">
              <?php foreach ($data_absensi_kelas->result() as $value) { ?>
                <?php 
                ...
                ?>
                <a href="<?=base_url('absen_kelas/').$value->id_kelas_matkul."/".$value->kode?>">
